...
const Features = () => {
  const features = [
    ...
    { title: "Personalized Mentorship", icon: <UserPlus className="w-12 h-12 mb-4 text-blue-600" />, description: "Get one-on-one guidance for your projects, career decisions, and technical challenges from experienced professionals in the Indian tech industry." },
    { title: "Resume Editing", icon: <Edit className="w-12 h-12 mb-4 text-blue-500" />, description: "Professional assistance to make your resume stand out, tailored to catch the eye of top tech recruiters from TCS, Cognizant, and Mindtree." },
  ];
