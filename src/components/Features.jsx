...
const Features = () => {
  const features = [
    { title: "Intensive 3-Month Internship", icon: <Award className="w-12 h-12 mb-4 text-yellow-500" />, description: "Accelerated program designed to rapidly prepare BTech students for top internships at leading companies like TCS, Cognizant, and Mindtree in just 3 months." },
    { title: "Certified Internship Certificate", icon: <BookOpen className="w-12 h-12 mb-4 text-green-500" />, description: "Earn a valuable 3-month internship credential recognized by leading tech companies across India, instantly boosting your resume and career prospects." },
    { title: "Fast-Track Hands-on Training", icon: <Code className="w-12 h-12 mb-4 text-purple-500" />, description: "Receive intensive, industry-relevant training in full-stack development, Python, and cloud computing with rapid hands-on projects completed within the 3-month timeframe." },
    ...
    { title: "Rapid Personalized Mentorship", icon: <UserPlus className="w-12 h-12 mb-4 text-blue-600" />, description: "Receive intensive one-on-one guidance for your projects, career decisions, and technical challenges from experienced professionals in the Indian tech industry, compressed into our 3-month timeline." },
  ...
  return (
    <section id="features" className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-16">Accelerated 3-Month Program Features</h2>
